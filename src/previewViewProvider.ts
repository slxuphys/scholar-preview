...
${renderedHtml}
  ...
  private getHtml(webview: vscode.Webview): string {
    ...
    const pagedScriptUri = webview.asWebviewUri(vscode.Uri.joinPath(this.extensionUri, "media", "paged.min.js"));
...
<body>
  <header class="toolbar">
    ...
    <button id="tocButton" type="button" title="Table of contents" aria-expanded="false" aria-controls="tocPanel">
      <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
        <path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm-3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
      </svg>
    </button>
    <button id="togglePageModeButton" type="button" title="Toggle page mode" aria-pressed="false">
      <svg width="14" height="14" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
  ...
  <main>
    <div id="tocPanel" role="dialog" aria-label="Table of contents" hidden></div>
